...
export const Footer = () => {
  return (
    <footer
      ...
      className="bg-[#0a0a0a] text-white border-t-4 border-[#7dd3fc]"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-4">
            <h4 className="font-body text-xs uppercase tracking-[0.25em] font-bold text-[#7dd3fc] mb-5">
              Lessons
            </h4>
              ...
              {SERVICES.map((s) => (
                <li key={s.name}>
                  <a
                    ...
                    className="text-white/80 hover:text-[#7dd3fc] transition-colors"
                  >
                    {s.name}
                  </a>
                </li>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3 font-body text-sm text-white/80">
              <li>
                <a href={`tel:${BUSINESS.phoneTel}`} data-testid="footer-phone" className="hover:text-[#7dd3fc] transition-colors">
                  {BUSINESS.phone}
                </a>
              </li>
              <li>
